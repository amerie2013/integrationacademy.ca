// Generate MHF4U worksheet .tex files from a content module.
//   node scripts/mhf4u-worksheets/build.mjs scripts/mhf4u-worksheets/content/u2.mjs
import fs from "fs";
...
\\input{_preamble}
\\fancyhead[R]{\\footnotesize MHF4U \\textperiodcentered{} ${w.code}}
\\begin{document}

\\begin{center}
{\\LARGE\\bfseries\\color{titleblue}Worksheet ${w.code} --- ${esc(w.title)}}\\\\[2pt]
{\\small Grade 12 Advanced Functions (MHF4U) \\textperiodcentered{} Unit ${w.unit}}
\\end{center}
