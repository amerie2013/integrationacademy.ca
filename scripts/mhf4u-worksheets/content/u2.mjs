...
export default [
  ...
  },
  {
    ...
    examples: [
      ...
      { t: "Grouping", body: r`Solve $x^3+2x^2-x-2=0$.\soln $x^2(x+2)-(x+2)=(x+2)(x-1)(x+1)=0\Rightarrow x=-2,1,-1$:` + r`\eplot{-2.4}{1.5}{-3}{4}{\addplot[exblue,very thick,domain=-2.3:1.4]{x^3+2*x^2-x-2};\addplot[red,only marks,mark=*,mark size=1.6pt] coordinates {(-2,0) (-1,0) (1,0)};}` },
      { t: "Factor theorem", body: r`Solve $x^3-7x-6=0$.\soln $P(-1)=0$; divide → $(x+1)(x-3)(x+2)=0\Rightarrow x=-1,3,-2$:` + r`\eplot{-2.5}{3.3}{-14}{6}{\addplot[exblue,very thick,domain=-2.4:3.2]{x^3-7*x-6};\addplot[red,only marks,mark=*,mark size=1.6pt] coordinates {(-2,0) (-1,0) (3,0)};}` },
      { t: "Quadratic in $x^2$", body: r`Solve $x^4-5x^2+4=0$.\soln $(x^2-1)(x^2-4)=0\Rightarrow x=\pm1,\pm2$:` + r`\eplot{-2.3}{2.3}{-3}{9}{\addplot[exblue,very thick,domain=-2.2:2.2]{x^4-5*x^2+4};\addplot[red,only marks,mark=*,mark size=1.6pt] coordinates {(-2,0) (-1,0) (1,0) (2,0)};}` },
      { t: "Common factor", body: r`Solve $x^3-9x=0$.\soln $x(x-3)(x+3)=0\Rightarrow x=0,3,-3$:` + r`\eplot{-3.4}{3.4}{-11}{11}{\addplot[exblue,very thick,domain=-3.3:3.3]{x^3-9*x};\addplot[red,only marks,mark=*,mark size=1.6pt] coordinates {(-3,0) (0,0) (3,0)};}` },
      { t: "Trinomial", body: r`Solve $x^3-x^2-2x=0$.\soln $x(x-2)(x+1)=0\Rightarrow x=0,2,-1$:` + r`\eplot{-1.4}{2.4}{-3}{4}{\addplot[exblue,very thick,domain=-1.3:2.3]{x^3-x^2-2*x};\addplot[red,only marks,mark=*,mark size=1.6pt] coordinates {(-1,0) (0,0) (2,0)};}` },
      { t: "Grouping", body: r`Solve $x^3+3x^2-x-3=0$.\soln $(x+3)(x-1)(x+1)=0\Rightarrow x=-3,1,-1$:` + r`\eplot{-3.4}{1.4}{-5}{5}{\addplot[exblue,very thick,domain=-3.3:1.3]{x^3+3*x^2-x-3};\addplot[red,only marks,mark=*,mark size=1.6pt] coordinates {(-3,0) (-1,0) (1,0)};}` },
      { t: "Factor theorem", body: r`Solve $x^3-4x^2+x+6=0$ (hint $x=-1$).\soln $(x+1)(x-2)(x-3)=0\Rightarrow x=-1,2,3$:` + r`\eplot{-1.4}{3.4}{-7}{7}{\addplot[exblue,very thick,domain=-1.3:3.3]{x^3-4*x^2+x+6};\addplot[red,only marks,mark=*,mark size=1.6pt] coordinates {(-1,0) (2,0) (3,0)};}` },
    ],
    questions: [
