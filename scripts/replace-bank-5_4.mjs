// Replace ONLY the "5.4 The Pythagorean Theorem" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-5_4.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen54 } from "./seed-bank.mjs";
...
const TOPIC = "5.4 The Pythagorean Theorem";
const LESSON_POS = 27; // 5.4 is position 27 (after 4.7-4.9 inserted)
