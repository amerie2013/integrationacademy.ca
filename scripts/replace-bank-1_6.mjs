// Replace ONLY the "1.6 Fractions & Unit Fractions" questions in the MTH1W bank,
// leaving every other topic (and any hand-added questions) untouched.
// Re-runnable. Usage: node scripts/replace-bank-1_6.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen16 } from "./seed-bank.mjs";
...
const TOPIC = "1.6 Fractions & Unit Fractions";
const LESSON_POS = 5; // 1.6 is the sixth lesson
