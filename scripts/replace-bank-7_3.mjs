// Replace ONLY the "7.3 Interest & Borrowing" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-7_3.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen73 } from "./seed-bank.mjs";
...
const TOPIC = "7.3 Interest & Borrowing";
const LESSON_POS = 38; // 7.3 is position 38 (after 4.7-4.9 inserted)
