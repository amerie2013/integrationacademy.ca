// Replace ONLY the "2.3 Simplifying Expressions" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-2_3.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen23 } from "./seed-bank.mjs";
...
const TOPIC = "2.3 Simplifying Expressions";
const LESSON_POS = 10; // 2.3 is position 10
