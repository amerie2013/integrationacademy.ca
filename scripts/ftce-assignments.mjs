...
export const ASSIGN = {
  ...
  // ── Unit 10: Mathematics as Communication ────────────────────
  "10.1": A3("10.1", "Mathematics as Communication",
    ["What does 'at least one' mean?", "What kind of conditions must a definition give?", "What does 'if and only if' assert?", "Name the three modes of representation."],
    ["Write a precise definition of a square and explain why 'four equal sides' alone is insufficient.", "Give a concrete, a pictorial, and a symbolic representation of $\\tfrac34$.", "Explain the difference between a description and a definition of 'even number'."],
    ["Explain why precise terminology matters in mathematics instruction.", "Explain how connecting representations deepens understanding.", "Explain the difference between necessary and sufficient conditions in a definition."]),
  "11.1": A3("11.1", "Reasoning: Arguments, Deduction & Induction",
    ["Is reasoning from general to specific deductive or inductive?", "Is generalizing from examples deductive or inductive?", "What guarantees a deductive conclusion?", "What disproves a universal claim?"],
    ["Classify: 'All primes greater than 2 are odd; 7 is such a prime; so 7 is odd.'", "Give a counterexample to 'all even numbers are multiples of 4.'", "Explain why inductive conclusions are only probable."],
    ["Explain the difference between deductive validity and inductive strength.", "Explain why validity depends on form rather than content.", "Explain the role of counterexamples in mathematical reasoning."]),
  "11.2": A3("11.2", "Conditional Statements & Logical Equivalence",
    ["Give the converse of 'if $A$ then $B$.'", "Give the contrapositive of 'if $A$ then $B$.'", "Which statement is equivalent to the original conditional?", "What is 'if and only if' called?"],
    ["Write the converse, inverse, and contrapositive of 'if a number is divisible by 4, then it is even.'", "Which of those are true, and which are equivalent?", "Restate 'a triangle is equilateral iff all its angles are equal' as two conditionals."],
    ["Explain why a conditional and its contrapositive are logically equivalent.", "Explain why the converse is not equivalent to the original.", "Explain necessary versus sufficient conditions using $p\\to q$."]),
  "11.3": A3("11.3", "Methods of Proof: Induction & Indirect Proof",
    ["What does a proof by contradiction assume?", "What two parts does an induction proof require?", "What set of numbers does induction establish results for?", "What disproves a universal statement?"],
    ["Outline a proof by contradiction that $\\sqrt2$ is irrational.", "State the base case and inductive step to prove $1+2+\\cdots+n=\\tfrac{n(n+1)}{2}$.", "Explain why one counterexample suffices to refute a general claim."],
    ["Explain the logic of proof by contradiction.", "Explain why the base case is essential in induction.", "Explain the difference between a direct and an indirect proof."]),
  "12.1": A3("12.1", "Mathematical Connections & Representations",
    ["Name the four common representations of a function.", "What does an array/area model represent?", "What do base-ten blocks model?", "What can algebra tiles model?"],
    ["Represent $y=3x-2$ as a table, a graph description, and a verbal rule.", "Explain how the area model connects multiplication to the distributive property.", "Give an example of a concept that recurs across two different courses."],
    ["Explain how equivalent representations each highlight a different aspect of a concept.", "Explain how algebra tiles connect a geometric picture to symbolic factoring.", "Explain why building connections improves retention and transfer."]),
  "13.1": A3("13.1", "Instruction & Problem Solving",
    ["Name a common problem-solving strategy.", "What is 'wait time'?", "What learning theory views students as active builders of understanding?", "Name a student-centered delivery method."],
    ["Choose a suitable strategy for: 'A number tripled and increased by 4 is 25 — find it,' and solve by working backwards.", "Describe how you would use a table to solve a pattern problem.", "Explain how estimation checks the reasonableness of a computed answer."],
    ["Explain what pedagogical content knowledge adds beyond subject knowledge.", "Explain the trade-offs between lecture and discovery learning.", "Explain how questioning and wait time promote mathematical thinking."]),
  "14.1": A3("14.1", "Assessment in Mathematics",
    ["Which assessment guides instruction during learning?", "Which assessment evaluates at the end of a unit?", "Name an alternative assessment.", "What tool gives consistent scoring criteria?"],
    ["Describe how you would use formative assessment to adjust a lesson mid-unit.", "Design a rubric criterion for a problem-solving task.", "A student computes $\\tfrac12+\\tfrac13=\\tfrac25$; identify the misconception."],
    ["Explain the difference between formative and summative assessment.", "Explain the value of alternative assessments such as portfolios.", "Explain how analyzing wrong answers informs instruction and MC distractor design."]),
};
