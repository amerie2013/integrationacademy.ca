// Replace ONLY the "5.6 Changing Dimensions: Area" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-5_6.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen56 } from "./seed-bank.mjs";
...
const TOPIC = "5.6 Changing Dimensions: Area";
const LESSON_POS = 29; // 5.6 is position 29 (after 4.7-4.9 inserted)
