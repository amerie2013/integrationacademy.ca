// Replace ONLY the "6.2 One-Variable Data & Statistics" questions in the MTH1W
// bank, leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-6_2.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen62 } from "./seed-bank.mjs";
...
const TOPIC = "6.2 One-Variable Data & Statistics";
const LESSON_POS = 33; // 6.2 is position 33 (after 4.7-4.9 inserted)
