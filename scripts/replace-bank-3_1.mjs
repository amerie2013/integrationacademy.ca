// Replace ONLY the "3.1 Coding Algebraic Concepts" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-3_1.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen31 } from "./seed-bank.mjs";
...
const TOPIC = "3.1 Coding Algebraic Concepts";
const LESSON_POS = 12; // 3.1 is position 12
