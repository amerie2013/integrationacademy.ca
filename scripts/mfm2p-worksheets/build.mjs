// Generate MFM2P worksheet .tex files from a content module.
//   node scripts/mfm2p-worksheets/build.mjs scripts/mfm2p-worksheets/content/reused.mjs
// Same content shape as the MPM2D worksheets.
import fs from "fs";
...
\\input{_preamble}
\\fancyhead[R]{\\footnotesize MFM2P \\textperiodcentered{} ${w.code}}
\\begin{document}

\\begin{center}
{\\LARGE\\bfseries\\color{titleblue}Worksheet ${w.code} --- ${w.title}}\\\\[2pt]
{\\small Grade 10 Applied (MFM2P) \\textperiodcentered{} Unit ${w.unit}}
\\end{center}
