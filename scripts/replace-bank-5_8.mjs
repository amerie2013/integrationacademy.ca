// Replace ONLY the "5.8 Surface Area" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-5_8.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen58 } from "./seed-bank.mjs";
...
const TOPIC = "5.8 Surface Area";
const LESSON_POS = 31; // 5.8 is position 31 (after 4.7-4.9 inserted)
