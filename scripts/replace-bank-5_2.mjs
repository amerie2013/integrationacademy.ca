// Replace ONLY the "5.2 Designs with Circle & Triangle Properties" questions in
// the MTH1W bank, leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-5_2.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen52 } from "./seed-bank.mjs";
...
const TOPIC = "5.2 Designs with Circle & Triangle Properties";
const LESSON_POS = 25; // 5.2 is position 25 (after 4.7-4.9 inserted)
