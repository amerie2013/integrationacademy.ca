// Replace ONLY the "2.2 Equivalent Expressions" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-2_2.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen22 } from "./seed-bank.mjs";
...
const LESSON_POS = 9; // 2.2 is position 9
