// Seed (or re-seed) the Algebra 1 (FL B.E.S.T.) question bank from a unit module.
//   node scripts/bank-flalg1/seed.mjs scripts/bank-flalg1/u1.mjs
...
if (!course) { console.error("ALG1 course not found."); process.exit(1); }
...
console.log(`\nSeeded ${total} ALG1 bank questions.`);
