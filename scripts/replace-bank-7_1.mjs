// Replace ONLY the "7.1 Making Financial Decisions" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-7_1.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen71 } from "./seed-bank.mjs";
...
const TOPIC = "7.1 Making Financial Decisions";
const LESSON_POS = 36; // 7.1 is position 36 (after 4.7-4.9 inserted)
