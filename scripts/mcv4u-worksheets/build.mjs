// Generate MCV4U worksheet .tex files from a content module.
//   node scripts/mcv4u-worksheets/build.mjs scripts/mcv4u-worksheets/content/u2.mjs
import fs from "fs";
...
\\input{_preamble}
\\fancyhead[R]{\\footnotesize MCV4U \\textperiodcentered{} ${w.code}}
\\begin{document}

\\begin{center}
{\\LARGE\\bfseries\\color{titleblue}Worksheet ${w.code} --- ${esc(w.title)}}\\\\[2pt]
{\\small Grade 12 Calculus and Vectors (MCV4U) \\textperiodcentered{} Unit ${w.unit}}
\\end{center}
