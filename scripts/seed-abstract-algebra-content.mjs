...
// ================================================================
const arNote = (text) =>
  `<div dir="rtl" style="margin-top:8px;padding:8px 10px;background:#eef2ff;border-right:4px solid #3b5bdb;border-radius:6px;font-family:Tahoma,'Segoe UI',Arial,sans-serif;line-height:1.85;text-align:right;font-size:10pt;">🗣️ ${text}</div>`;
