// Replace ONLY the "1.8 Ratios, Rates, Percentages & Proportions" questions in
// the MTH1W bank, leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-1_8.mjs
...
const TOPIC = "1.8 Ratios, Rates, Percentages & Proportions";
const LESSON_POS = 7; // 1.8 is the eighth lesson
