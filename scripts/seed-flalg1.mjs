...
const subjects = [
  ...
  sk("3.2", "Solving Systems by Elimination", "Add or subtract equations — scaling first when needed — to eliminate a variable and solve efficiently.", ["Eliminating a variable by adding or subtracting", "Scaling equations to line up coefficients", "Solving and checking the result"]),
  sk("3.3", "Real-World Systems Applications & Special Cases (No/Infinite Solutions)", "Model situations with a system of equations, and recognize when a system has one, no, or infinitely many solutions.", ["Setting up a system from a word problem", "One solution vs. no solution vs. infinitely many", "Interpreting special cases in context"]),
  sk("3.4", "Graphing Two-Variable Linear Inequalities & Systems", "Graph the solution region of a linear inequality, and of a system of inequalities, using boundary lines and shading.", ["Boundary line: solid ($\\le,\\ge$) vs. dashed ($<,>$)", "Choosing which side to shade", "The overlapping solution region of a system"]),
  ...
  sk("4.3", "Addition, Subtraction, and Multiplication of Polynomials", "Add, subtract, and multiply polynomials, keeping track of like terms and the distributive property.", ["Adding and subtracting polynomials", "Multiplying a polynomial by a monomial", "Multiplying binomials (FOIL) and larger products"]),
  sk("4.4", "Special Polynomial Products (Difference of Squares, Perfect Square Trinomials)", "Recognize and use the product patterns that appear again and again in algebra.", ["Difference of squares: $(a+b)(a-b)=a^{2}-b^{2}$", "Perfect square trinomials: $(a\\pm b)^{2}=a^{2}\\pm 2ab+b^{2}$", "Spotting these patterns to expand quickly"]),
  ...
  sk("5.2", "Factoring Trinomials ($ax^2 + bx + c$)", "Factor quadratic trinomials, first when the leading coefficient is 1 and then when it is not.", ["Factoring $x^{2}+bx+c$", "Factoring $ax^{2}+bx+c$ with $a\\neq 1$", "Special cases and recognizing primes"]),
