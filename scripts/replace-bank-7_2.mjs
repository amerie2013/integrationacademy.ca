// Replace ONLY the "7.2 Appreciation & Depreciation" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-7_2.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen72 } from "./seed-bank.mjs";
...
const TOPIC = "7.2 Appreciation & Depreciation";
const LESSON_POS = 37; // 7.2 is position 37 (after 4.7-4.9 inserted)
