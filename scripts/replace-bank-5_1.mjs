// Replace ONLY the "5.1 Geometry & Measurement Through History" questions in the
// MTH1W bank, leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-5_1.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen51 } from "./seed-bank.mjs";
...
const LESSON_POS = 24; // 5.1 is position 24 (after 4.7-4.9 inserted)
