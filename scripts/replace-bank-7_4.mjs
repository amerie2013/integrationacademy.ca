// Replace ONLY the "7.4 Budgets" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-7_4.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen74 } from "./seed-bank.mjs";
...
const LESSON_POS = 37; // 7.4 is position 39 (after 4.7-4.9 inserted)
