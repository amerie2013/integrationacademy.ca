// Replace ONLY the "5.3 Units & Unit Conversion" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-5_3.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen53 } from "./seed-bank.mjs";
...
const TOPIC = "5.3 Units & Unit Conversion";
const LESSON_POS = 26; // 5.3 is position 26 (after 4.7-4.9 inserted)
