// Replace ONLY the "3.3 Reading, Predicting & Altering Code" questions in the
// MTH1W bank, leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-3_3.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen33 } from "./seed-bank.mjs";
...
const LESSON_POS = 12; // 3.3 is position 14
