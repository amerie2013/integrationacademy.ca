// Generate MDM4U worksheet .tex files from a content module.
//   node scripts/mdm4u-worksheets/build.mjs scripts/mdm4u-worksheets/content/u1.mjs
import fs from "fs";
...
\\input{_preamble}
\\fancyhead[R]{\\footnotesize MDM4U \\textperiodcentered{} ${w.code}}
\\begin{document}

\\begin{center}
{\\LARGE\\bfseries\\color{titleblue}Worksheet ${w.code} --- ${esc(w.title)}}\\\\[2pt]
{\\small Grade 12 Mathematics of Data Management (MDM4U) \\textperiodcentered{} Unit ${esc(w.unit)}}
\\end{center}
