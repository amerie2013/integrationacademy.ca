// Replace ONLY the "6.3 Scatter Plots & Correlation" questions in the MTH1W
// bank, leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-6_3.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen63 } from "./seed-bank.mjs";
...
const TOPIC = "6.3 Scatter Plots & Correlation";
const LESSON_POS = 34; // 6.3 is position 34 (after 4.7-4.9 inserted)
