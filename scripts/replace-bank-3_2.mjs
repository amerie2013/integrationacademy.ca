// Replace ONLY the "3.2 Building Code from Steps" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-3_2.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen32 } from "./seed-bank.mjs";
...
const TOPIC = "3.2 Building Code from Steps";
const LESSON_POS = 13; // 3.2 is position 13
