...
export default {
  ...
  intro: "This worksheet takes fractions from building and comparing right through to computing with them — adding, subtracting, multiplying, and dividing, with positive and negative signs and order of operations. The problems are deliberately <i>above the usual Grade&nbsp;9 level</i>: expect several steps, negatives, and word problems.",
  examples: [
    ...
    ["Example 3: Mixed &harr; improper", "Write $\\dfrac{23}{6}$ as a mixed number and $3\\dfrac{3}{4}$ as improper.", "$23\\div6 = 3$ r $5$, so $\\dfrac{23}{6}=3\\dfrac{5}{6}$. And $3\\dfrac{3}{4}=\\dfrac{3\\times4+3}{4}=\\dfrac{15}{4}$."],
