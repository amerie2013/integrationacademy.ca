// Replace ONLY the "1.3 Powers & Scientific Notation" questions in the MTH1W
// bank, leaving every other topic (and any hand-added questions) untouched.
// Re-runnable. Usage: node scripts/replace-bank-1_3.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { genPowersExp } from "./seed-bank.mjs";
...
const TOPIC = "1.3 Powers, Scientific Notation & Exponent Laws";
const LESSON_POS = 2; // 1.3 is the third lesson
