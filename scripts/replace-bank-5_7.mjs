// Replace ONLY the "5.7 Volume" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-5_7.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen57 } from "./seed-bank.mjs";
...
const TOPIC = "5.7 Volume";
const LESSON_POS = 30; // 5.7 is position 30 (after 4.7-4.9 inserted)
