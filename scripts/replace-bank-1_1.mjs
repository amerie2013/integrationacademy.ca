// Replace ONLY the "1.1 Number Sets & Their Subsets" questions in the MTH1W
// bank, leaving every other topic (and any hand-added questions) untouched.
// Re-runnable. Usage: node scripts/replace-bank-1_1.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen11 } from "./seed-bank.mjs";
...
const TOPIC = "1.1 Number Sets & Their Subsets";
const LESSON_POS = 0; // 1.1 is the first lesson
