// Replace ONLY the "2.1 From Words to Algebraic Expressions" questions in the
// MTH1W bank, leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-2_1.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen21 } from "./seed-bank.mjs";
...
const TOPIC = "2.1 From Words to Algebraic Expressions";
const LESSON_POS = 8; // 2.1 is the ninth lesson (position 8)
