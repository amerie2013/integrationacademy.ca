// Replace ONLY the "5.5 Changing Dimensions: Perimeter" questions in the MTH1W
// bank, leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-5_5.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen55 } from "./seed-bank.mjs";
...
const TOPIC = "5.5 Changing Dimensions: Perimeter";
const LESSON_POS = 28; // 5.5 is position 28 (after 4.7-4.9 inserted)
