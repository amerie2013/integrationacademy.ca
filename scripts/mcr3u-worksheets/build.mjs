// Generate MCR3U worksheet .tex files from a content module.
//   node scripts/mcr3u-worksheets/build.mjs scripts/mcr3u-worksheets/content/u2.mjs
import fs from "fs";
...
\\input{_preamble}
\\fancyhead[R]{\\footnotesize MCR3U \\textperiodcentered{} ${w.code}}
\\begin{document}

\\begin{center}
{\\LARGE\\bfseries\\color{titleblue}Worksheet ${w.code} --- ${esc(w.title)}}\\\\[2pt]
{\\small Grade 11 Functions, University (MCR3U) \\textperiodcentered{} Unit ${w.unit}}
\\end{center}
