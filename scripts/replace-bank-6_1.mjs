// Replace ONLY the "6.1 Big Data & Its Implications" questions in the MTH1W bank,
// leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-6_1.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen61 } from "./seed-bank.mjs";
...
const TOPIC = "6.1 Big Data & Its Implications";
const LESSON_POS = 32; // 6.1 is position 32 (after 4.7-4.9 inserted)
