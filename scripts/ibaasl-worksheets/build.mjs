// Generate IB AA SL worksheet .tex files from a content module.
//   node scripts/ibaasl-worksheets/build.mjs scripts/ibaasl-worksheets/content/u2.mjs
import fs from "fs";
...
\\input{_preamble}
\\fancyhead[R]{\\footnotesize IB AA SL \\textperiodcentered{} ${w.code}}
\\begin{document}

\\begin{center}
{\\LARGE\\bfseries\\color{titleblue}Worksheet ${w.code} --- ${esc(w.title)}}\\\\[2pt]
{\\small Mathematics: Analysis \\& Approaches SL (IB) \\textperiodcentered{} Unit ${esc(w.unit)}}
\\end{center}
