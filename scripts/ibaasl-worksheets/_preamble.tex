% ===========================================================================
%  Shared preamble for all IB AA SL worksheets — input right after \documentclass.
%  (Files beginning with "_" are skipped by ibaasl-worksheet-publish.mjs.)
% ===========================================================================
...
\fancyhead[R]{\footnotesize IB AA SL}
...
% A sine-curve plot (radians on x, as a decimal axis): \splot{ymin}{ymax}{body}
\newcommand{\splot}[3]{\begin{center}\begin{tikzpicture}
\begin{axis}[width=8.6cm,height=4.6cm,axis lines=middle,xlabel={\tiny$x$},ylabel={\tiny$y$},
grid=both,grid style={gray!16},xmin=-6.3,xmax=6.3,ymin=#1,ymax=#2,
xtick distance=1.5708,ytick distance=1,tick label style={font=\tiny},axis line style={-},samples=180]
#3
\end{axis}\end{tikzpicture}\end{center}}
...
% A sector diagram (circle with two radii and an arc): \sector{radiusScale}{angleDeg}{label}
\newcommand{\sector}[3]{\begin{center}\begin{tikzpicture}[scale=0.85]
\coordinate (O) at (0,0);
\draw[thick,exblue] (O) -- (#2:#1) arc (#2:0:#1) -- cycle;
\draw[gray!40] (O) circle (#1);
