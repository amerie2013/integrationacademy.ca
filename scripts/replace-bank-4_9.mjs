// Replace ONLY the "4.9 Parallel and Perpendicular Lines" questions in the
// MTH1W bank, leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-4_9.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen49 } from "./seed-bank.mjs";
...
const TOPIC = "4.9 Parallel and Perpendicular Lines";
const LESSON_POS = 23; // 4.9 is position 23
