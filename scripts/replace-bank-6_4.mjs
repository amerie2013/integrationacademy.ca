// Replace ONLY the "6.4 The Mathematical Modelling Process" questions in the
// MTH1W bank, leaving every other topic untouched.
// Re-runnable. Usage: node scripts/replace-bank-6_4.mjs

import { createClient } from "@supabase/supabase-js";
import { readFileSync } from "fs";
import { fileURLToPath } from "url";
import { dirname, join } from "path";
import { gen64 } from "./seed-bank.mjs";
...
const LESSON_POS = 33; // 6.4 is position 35 (after 4.7-4.9 inserted)
