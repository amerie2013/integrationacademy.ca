...
authored["5.2"] = L("5.2", "Factoring Trinomials when a = 1 (x² + bx + c)", [html(String.raw`<div class="lecture-box">
  ...
  html(String.raw`<div class="lecture-box">
  <h2>🔵 Examples</h2>
  <div class="example-box" ${EX}><h3>Example 1: all positive</h3><p>Factor \(x^2 + 7x + 12\).</p><div class="solution"><div class="step"><strong>Step 1: Finding 'p' and 'q':&nbsp;</strong>\( p \times q = 12, p + q = 7 \)</div><div class="step"><strong>Step 2: Checking the values:</strong> \(p=3\) and \(q=4\) (since \(3\cdot4=12\), \(3+4=7\)).</div><div class="step"><b>Step 3: Solve: </b>&nbsp;\( x^2+7x+12 = (x+3)(x+4) \)</div><em>Conclusion: \((x + 3)(x + 4)\). ✓</em></div><div class="solution"><br></div><iframe src="https://www.integrationacademy.ca/tools/graph?embed=1&amp;id=5ab74e93-c5a4-489d-a925-bf621254fd24" width="700" height="500" style="border:0;border-radius:12px;" allow="autoplay"></iframe></div>
