...
authored["5.1"] = L("5.1", "GCF and Factoring by Grouping", [html(String.raw`<div class="lecture-box">
  ...
  html(String.raw`<div class="lecture-box">
  <h2>🔵 Examples</h2>
  <div class="example-box" ${EX}><h3>Example 1: GCF of a binomial</h3><p>Factor \(6x^2 + 9x\).</p><div class="solution"><div class="step"><strong>Step 1:&nbsp;</strong>&nbsp;\(6x^2 + 9x= \textcolor{red}{3} \times 2 \times \textcolor{red}{x} \times x + \textcolor{red}{3} \times 3 \times \textcolor{red}{x} \)</div><div class="step"><strong>Step 2: GCF is \(\textcolor{red}{3x}\):</strong> \(3x(2x + 3)\).</div><em>Conclusion: \(3x(2x + 3)\). ✓</em></div>
  ...
  <div class="example-box" ${EX}><h3>Example 2: A larger GCF</h3><p>Factor \(12x^3 - 8x^2\).</p><div class="solution"><div class="step"><strong>Step 1:&nbsp;</strong>&nbsp;\(12x^3 - 8x^2= \textcolor{red}{4} \times 3 \times \textcolor{red}{x^2} \times x - \textcolor{red}{4} \times 2 \times \textcolor{red}{x^2} \)</div><div class="step"><strong>Step 2: GCF is \(\textcolor{red}{4x^2}\):</strong> \(4x^2(3x - 2)\).</div><em>Conclusion: \(4x^2(3x - 2)\). ✓</em></div>
  <div style="margin:14px 0 4px">
    <div style="font-size:12px;font-weight:800;letter-spacing:0.04em;text-transform:uppercase;color:#64748b;margin-bottom:8px">Graph check</div>
  ...
  <div class="example-box" ${EX}><h3>Example 3: Factor by grouping</h3><p>Factor \(x^3 + 2x^2 + 3x + 6\).</p><div class="solution"><div class="step"><strong>Step 1: group in pairs:</strong> \((x^3 + 2x^2) + (3x + 6)\)</div><div class="step"><strong>Step 2: factor each pair:</strong> \(x^2\textcolor{red}{(x + 2)} + 3\textcolor{red}{(x + 2)}\)</div><div class="step"><strong>Step 3: factor out \(\textcolor{red}{(x + 2)}\):</strong> \(\textcolor{red}{(x + 2)}(x^2 + 3)\)</div><em>Conclusion: \((x + 2)(x^2 + 3)\). ✓</em></div>
  <div style="margin:14px 0 4px">
    <div style="font-size:12px;font-weight:800;letter-spacing:0.04em;text-transform:uppercase;color:#64748b;margin-bottom:8px">Graph check</div>
  ...
  <div class="example-box" ${EX}><h3>Example 4: Grouping with coefficients</h3><p>Factor \(2x^3 + 6x^2 + x + 3\).</p><div class="solution"><div class="step"><strong>Step 1: group in pairs:</strong> \((2x^3 + 6x^2) + (x + 3)\)</div><div class="step"><strong>Step 2: factor each pair:</strong> \(2x^2\textcolor{red}{(x + 3)} + 1\textcolor{red}{(x + 3)}\)</div><div class="step"><strong>Step 3: factor out \(\textcolor{red}{(x + 3)}\):</strong> \(\textcolor{red}{(x + 3)}(2x^2 + 1)\)</div><em>Conclusion: \((x + 3)(2x^2 + 1)\). ✓</em></div>
  <div style="margin:14px 0 4px">
    <div style="font-size:12px;font-weight:800;letter-spacing:0.04em;text-transform:uppercase;color:#64748b;margin-bottom:8px">Graph check</div>
  ...
  <div class="example-box" ${EX}><h3>Example 5: GCF first, then more</h3><p>Factor \(2x^3 - 8x\).</p><div class="solution"><div class="step"><strong>Step 1:&nbsp;</strong>&nbsp;\(2x^3 - 8x= \textcolor{red}{2} \times \textcolor{red}{x} \times x^2 - \textcolor{red}{2} \times 4 \times \textcolor{red}{x} \)</div><div class="step"><strong>Step 2: GCF is \(\textcolor{red}{2x}\):</strong> \(2x(x^2 - 4)\).</div><div class="step"><strong>Step 3: difference of squares:</strong> \(2x(x - 2)(x + 2)\).</div><em>Conclusion: \(2x(x - 2)(x + 2)\). ✓</em></div>
  <div style="margin:14px 0 4px">
    <div style="font-size:12px;font-weight:800;letter-spacing:0.04em;text-transform:uppercase;color:#64748b;margin-bottom:8px">Graph check</div>
...
authored["5.2"] = L("5.2", "Factoring Trinomials when a = 1 (x² + bx + c)", [html(String.raw`<div class="lecture-box">
  ...
  html(String.raw`<div class="lecture-box">
  <h2>🔵 Examples</h2>
  <div class="example-box" ${EX}><h3>Example 1: all positive</h3><p>Factor \(x^2 + 7x + 12\).</p><div class="solution"><div class="step"><strong>Step 1: Finding 'p' and 'q':&nbsp;</strong>\( p \times q = 12, p + q = 7 \)</div><div class="step"><strong>Step 2: Checking the values:</strong> \(p=3\) and \(q=4\) (since \(3\cdot4=12\), \(3+4=7\)).</div><div class="step"><b>Step 3: Solve: </b>&nbsp;\( x^2+7x+12 = (x+3)(x+4) \)</div><em>Conclusion: \((x + 3)(x + 4)\). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 2: negative middle, positive constant</h3><p>Factor \(x^2 - 5x + 6\).</p><div class="solution"><div class="step"><strong>Step 1: Finding 'p' and 'q':&nbsp;</strong>\( p \times q = 6, p + q = -5 \)</div><div class="step"><strong>Step 2: Checking the values:</strong> \(p=-2\) and \(q=-3\) (since \((-2)\cdot(-3)=6\), \(-2+(-3)=-5\)).</div><div class="step"><b>Step 3: Solve: </b>&nbsp;\( x^2-5x+6 = (x-2)(x-3) \)</div><em>Conclusion: \((x - 2)(x - 3)\). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 3: mixed signs</h3><p>Factor \(x^2 + 2x - 15\).</p><div class="solution"><div class="step"><strong>Step 1: Finding 'p' and 'q':&nbsp;</strong>\( p \times q = -15, p + q = 2 \)</div><div class="step"><strong>Step 2: Checking the values:</strong> \(p=5\) and \(q=-3\) (since \(5\cdot(-3)=-15\), \(5+(-3)=2\)).</div><div class="step"><b>Step 3: Solve: </b>&nbsp;\( x^2+2x-15 = (x+5)(x-3) \)</div><em>Conclusion: \((x + 5)(x - 3)\). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 4: negative constant, negative middle</h3><p>Factor \(x^2 - 3x - 10\).</p><div class="solution"><div class="step"><strong>Step 1: Finding 'p' and 'q':&nbsp;</strong>\( p \times q = -10, p + q = -3 \)</div><div class="step"><strong>Step 2: Checking the values:</strong> \(p=-5\) and \(q=2\) (since \((-5)\cdot 2=-10\), \(-5+2=-3\)).</div><div class="step"><b>Step 3: Solve: </b>&nbsp;\( x^2-3x-10 = (x-5)(x+2) \)</div><em>Conclusion: \((x - 5)(x + 2)\). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 5: a perfect-square trinomial</h3><p>Factor \(x^2 + 6x + 9\).</p><div class="solution"><div class="step"><strong>Step 1: Finding 'p' and 'q':&nbsp;</strong>\( p \times q = 9, p + q = 6 \)</div><div class="step"><strong>Step 2: Checking the values:</strong> \(p=3\) and \(q=3\) (since \(3\cdot3=9\), \(3+3=6\)) — a repeated factor.</div><div class="step"><b>Step 3: Solve: </b>&nbsp;\( x^2+6x+9 = (x+3)(x+3) = (x+3)^2 \)</div><em>Conclusion: \((x + 3)^2\). ✓</em></div></div>
  <h2>🟡 Practice Questions</h2>
...
authored["6.1"] = L("6.1", "Exponential Growth and Decay Models", [html(String.raw`<div class="lecture-box">
  ...
  html(String.raw`<div class="lecture-box">
  <h2>🔵 Examples</h2>
  <div class="example-box" ${EX}><h3>Example 1: Identify \(a\) and \(b\)</h3><p>For \(y = 100 \cdot 2^x\), state the starting amount and behaviour.</p><div class="solution"><div class="step"><strong>Step 1 — match \(y = a\,b^x\):</strong> here \(a = 100\) and \(b = 2\).</div><div class="step"><strong>Step 2 — starting amount:</strong> at \(x = 0\), \(y = 100 \cdot 2^0 = 100\), so it starts at \(100\).</div><div class="step"><strong>Step 3 — growth or decay:</strong> \(b = 2 &gt; 1\), so the amount doubles each step.</div><em>Conclusion: starts at 100 and doubles each step (growth). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 2: Growth or decay?</h3><p>Describe \(y = 50 \cdot (0.8)^x\).</p><div class="solution"><div class="step"><strong>Step 1 — identify \(a\) and \(b\):</strong> \(a = 50\), \(b = 0.8\).</div><div class="step"><strong>Step 2 — classify \(b\):</strong> since \(0 &lt; 0.8 &lt; 1\), the factor shrinks the amount — decay.</div><div class="step"><strong>Step 3 — interpret:</strong> multiplying by \(0.8\) keeps \(80\%\), so it loses \(20\%\) each step.</div><em>Conclusion: starts at 50, shrinks 20% each step (decay). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 3: Evaluate a model</h3><p>For \(y = 200 \cdot (1.05)^x\), find \(y\) when \(x = 3\).</p><div class="solution"><div class="step"><strong>Step 1 — substitute \(x = 3\):</strong> \(y = 200 \cdot (1.05)^3\).</div><div class="step"><strong>Step 2 — evaluate the power:</strong> \((1.05)^3 = 1.157625\).</div><div class="step"><strong>Step 3 — multiply:</strong> \(200 \cdot 1.157625 = 231.525\).</div><em>Conclusion: \(y \approx 231.53\). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 4: Build a growth model</h3><p>A town of 500 grows 10% per year. Write the model.</p><div class="solution"><div class="step"><strong>Step 1 — starting amount:</strong> \(a = 500\).</div><div class="step"><strong>Step 2 — factor from the percent:</strong> growth of \(10\%\) gives \(b = 1 + 0.10 = 1.1\).</div><div class="step"><strong>Step 3 — write the model:</strong> \(y = 500 \cdot (1.1)^x\).</div><em>Conclusion: \(y = 500(1.1)^x\). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 5: Build a decay model</h3><p>A $2000 car loses 15% of its value each year. What's it worth after 2 years?</p><div class="solution"><div class="step"><strong>Step 1 — starting amount:</strong> \(a = 2000\).</div><div class="step"><strong>Step 2 — decay factor:</strong> losing \(15\%\) keeps \(85\%\), so \(b = 1 - 0.15 = 0.85\) and \(y = 2000(0.85)^x\).</div><div class="step"><strong>Step 3 — substitute \(x = 2\):</strong> \(y = 2000 \cdot (0.85)^2\).</div><div class="step"><strong>Step 4 — compute:</strong> \((0.85)^2 = 0.7225\), so \(2000 \cdot 0.7225 = 1445\).</div><em>Conclusion: about $1445. ✓</em></div></div>
  <h2>🟡 Practice Questions</h2>
...
authored["6.2"] = L("6.2", "Comparing Linear, Quadratic, and Exponential Models", [html(String.raw`<div class="lecture-box">
  ...
  html(String.raw`<div class="lecture-box">
  <h2>🔵 Examples</h2>
  <div class="example-box" ${EX}><h3>Example 1: Spot a linear table</h3><p>\(y\)-values \(3, 7, 11, 15\) at \(x = 0,1,2,3\).</p><div class="solution"><div class="step"><strong>Step 1 — first differences:</strong> \(7-3=4\), \(11-7=4\), \(15-11=4\).</div><div class="step"><strong>Step 2 — read the pattern:</strong> the difference is constant (\(+4\) each step) — the fingerprint of a line.</div><div class="step"><strong>Step 3 — build it:</strong> start at \(3\) and add \(4\) each step, so \(y = 4x + 3\).</div><em>Conclusion: linear (\(y = 4x + 3\)). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 2: Spot an exponential table</h3><p>\(y\)-values \(2, 6, 18, 54\).</p><div class="solution"><div class="step"><strong>Step 1 — try differences:</strong> \(+4, +12, +36\) — not constant, so not linear.</div><div class="step"><strong>Step 2 — try ratios:</strong> \(6/2 = 3\), \(18/6 = 3\), \(54/18 = 3\) — a constant \(\times 3\).</div><div class="step"><strong>Step 3 — build it:</strong> start \(a = 2\), factor \(b = 3\), so \(y = 2 \cdot 3^x\).</div><em>Conclusion: exponential (\(y = 2 \cdot 3^x\)). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 3: Spot a quadratic table</h3><p>\(y\)-values \(1, 4, 9, 16\).</p><div class="solution"><div class="step"><strong>Step 1 — first differences:</strong> \(3, 5, 7\) — not constant, so not linear.</div><div class="step"><strong>Step 2 — second differences:</strong> \(5-3 = 2\), \(7-5 = 2\) — constant.</div><div class="step"><strong>Step 3 — read the pattern:</strong> constant second differences is the fingerprint of a quadratic.</div><em>Conclusion: quadratic (\(y = x^2\), shifted). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 4: Choose a model from a description</h3><p>“A balance earns 5% interest each year.” Which model?</p><div class="solution"><div class="step"><strong>Step 1 — find the key phrase:</strong> “\(5\%\) each year” means multiply by the same factor (\(\times 1.05\)) every year.</div><div class="step"><strong>Step 2 — match the fingerprint:</strong> a constant ratio (not a constant difference) is exponential.</div><em>Conclusion: exponential. ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 5: Which wins in the long run?</h3><p>Compare \(y = 10x\) (linear) and \(y = 2^x\) (exponential) for large \(x\).</p><div class="solution"><div class="step"><strong>Step 1 — evaluate both at \(x = 10\):</strong> \(10 \cdot 10 = 100\) vs \(2^{10} = 1024\).</div><div class="step"><strong>Step 2 — compare the trend:</strong> the exponential is already about \(10\times\) bigger, and the gap widens fast as \(x\) grows.</div><em>Conclusion: exponential growth eventually overtakes any linear (or quadratic) model. ✓</em></div></div>
  <h2>🟡 Practice Questions</h2>
...
authored["6.3"] = L("6.3", "Scatter Plots, Lines of Best Fit, and Residuals Analysis", [html(String.raw`<div class="lecture-box">
  ...
  html(String.raw`<div class="lecture-box">
  <h2>🔵 Examples</h2>
  <div class="example-box" ${EX}><h3>Example 1: Describe correlation</h3><p>As study hours rise, test scores rise. What correlation is that?</p><div class="solution"><div class="step"><strong>Step 1 — how do they move?</strong> as study hours go up, scores go up too.</div><div class="step"><strong>Step 2 — name it:</strong> both moving the same direction is a positive correlation, and the close link suggests it's strong.</div><em>Conclusion: positive (and likely strong). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 2: Predict with a best-fit line</h3><p>A best-fit line is \(y = 5x + 50\) (score vs. hours). Predict the score for 6 hours.</p><div class="solution"><div class="step"><strong>Step 1 — substitute \(x = 6\):</strong> \(y = 5(6) + 50\).</div><div class="step"><strong>Step 2 — compute:</strong> \(30 + 50 = 80\).</div><em>Conclusion: about 80. ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 3: Compute a residual</h3><p>The line predicts 80 but the student actually scored 85. Find the residual.</p><div class="solution"><div class="step"><strong>Step 1 — use the formula:</strong> residual \(= \text{actual} - \text{predicted}\).</div><div class="step"><strong>Step 2 — subtract:</strong> \(85 - 80 = 5\).</div><div class="step"><strong>Step 3 — interpret the sign:</strong> positive, so the real point sits above the line.</div><em>Conclusion: residual \(= +5\). ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 4: Interpolate vs. extrapolate</h3><p>The data covers 1–8 hours. Is predicting at 5 hours interpolation or extrapolation?</p><div class="solution"><div class="step"><strong>Step 1 — is \(5\) inside the data range \(1\)–\(8\)?</strong> Yes.</div><div class="step"><strong>Step 2 — name it:</strong> predicting inside the range is interpolation (more reliable); predicting outside — say at \(20\) hours — would be extrapolation.</div><em>Conclusion: interpolation. ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 5: Interpret the slope</h3><p>In \(y = 5x + 50\), what does the slope mean?</p><div class="solution"><div class="step"><strong>Step 1 — what the slope is:</strong> the change in \(y\) for each \(1\)-unit increase in \(x\).</div><div class="step"><strong>Step 2 — read it here:</strong> slope \(5\) means each extra hour of study is linked to about \(5\) more points.</div><em>Conclusion: +5 points per hour. ✓</em></div></div>
  <h2>🟡 Practice Questions</h2>
...
authored["6.4"] = L("6.4", "Two-Way Frequency Tables & Categorical Data", [html(String.raw`<div class="lecture-box">
  ...
  html(String.raw`<div class="lecture-box">
  <h2>🔵 Examples</h2>
  <div class="example-box" ${EX}><h3>Example 1: Joint frequency</h3><p>How many Grade 9 students play a sport?</p><div class="solution"><div class="step"><strong>Step 1 — what's being asked:</strong> a joint frequency — a single inner cell.</div><div class="step"><strong>Step 2 — read the table:</strong> Grade 9 row, “Plays a sport” column \(= 18\).</div><em>Conclusion: 18. ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 2: Marginal frequency</h3><p>How many students are in Grade 10 altogether?</p><div class="solution"><div class="step"><strong>Step 1 — “altogether” = a marginal total:</strong> a row or column total.</div><div class="step"><strong>Step 2 — read the table:</strong> the Grade 10 row Total \(= 30\).</div><em>Conclusion: 30. ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 3: Relative frequency</h3><p>What fraction of all students are Grade 9 athletes?</p><div class="solution"><div class="step"><strong>Step 1 — relative frequency:</strong> cell \(\div\) grand total.</div><div class="step"><strong>Step 2 — read the values:</strong> Grade 9 athletes \(= 18\); grand total \(= 60\).</div><div class="step"><strong>Step 3 — divide:</strong> \(\dfrac{18}{60} = 0.30\).</div><em>Conclusion: 30%. ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 4: Conditional relative frequency</h3><p>Among Grade 9 students, what fraction play a sport?</p><div class="solution"><div class="step"><strong>Step 1 — “among Grade 9” is conditional:</strong> divide by the Grade 9 row total, not the grand total.</div><div class="step"><strong>Step 2 — read the values:</strong> cell \(= 18\); Grade 9 row total \(= 30\).</div><div class="step"><strong>Step 3 — divide:</strong> \(\dfrac{18}{30} = 0.60\).</div><em>Conclusion: 60% of Grade 9 play. ✓</em></div></div>
  <div class="example-box" ${EX}><h3>Example 5: Is there an association?</h3><p>Compare the “plays a sport” rate by grade.</p><div class="solution"><div class="step"><strong>Step 1 — Grade 9 rate:</strong> \(\tfrac{18}{30} = 60\%\).</div><div class="step"><strong>Step 2 — Grade 10 rate:</strong> \(\tfrac{22}{30} \approx 73\%\).</div><div class="step"><strong>Step 3 — compare:</strong> the two conditional rates differ (\(60\%\) vs \(73\%\)).</div><em>Conclusion: the rates differ, so grade and playing a sport appear <strong>associated</strong>. ✓</em></div></div>
  <h2>🟡 Practice Questions</h2>
