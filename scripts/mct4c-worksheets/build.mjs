// Generate MCT4C worksheet .tex files from a content module.
//   node scripts/mct4c-worksheets/build.mjs scripts/mct4c-worksheets/content/u1.mjs
import fs from "fs";
...
\\input{_preamble}
\\fancyhead[R]{\\footnotesize MCT4C \\textperiodcentered{} ${w.code}}
\\begin{document}

\\begin{center}
{\\LARGE\\bfseries\\color{titleblue}Worksheet ${w.code} --- ${esc(w.title)}}\\\\[2pt]
{\\small Grade 12 Mathematics for College Technology (MCT4C) \\textperiodcentered{} Unit ${esc(w.unit)}}
\\end{center}
