...
u1["1.3"] = L("1.3", "Equations & Graphs of Polynomial Functions", [
  ...
  <div class="example-box" ${EX}><h3>Example 3: Find \(a\) for a quartic</h3><p>A quartic has a double zero at \(x=2\) and single zeros at \(x=-1\) and \(x=3\), and passes through \((0,6)\). Find \(a\).</p><div class="solution"><div class="step"><strong>Step 1:</strong> \(f(x)=a(x-2)^2(x+1)(x-3)\).</div><div class="step"><strong>Step 2:</strong> \(f(0)=a(4)(1)(-3)=-12a=6\).</div><em>Conclusion: \(a=-\tfrac12\). ✓</em></div>${gframe(["y = -0.5*(x-2)^2*(x+1)*(x-3)"], { title: "f(x) = −½(x−2)²(x+1)(x−3): crosses at −1 and 3, touches at 2, y-intercept (0,6)", labels: [{ x: -1, y: 0, t: "cross", c: "#2563a0" }, { x: 2, y: 0, t: "touch", c: "#a3327a" }, { x: 3, y: 0, t: "cross", c: "#2563a0" }, { x: 0, y: 6, t: "(0,6)", c: "#e69138" }] })}</div>
  <div class="example-box" ${EX}><h3>Example 4: Build an equation from a description</h3><p>Write an equation for a cubic that <em>crosses</em> at \(x=-3\), <em>touches</em> at \(x=1\), with a positive leading coefficient.</p><div class="solution"><div class="step"><strong>Step 1:</strong> Cross ⇒ factor \((x+3)\); touch ⇒ even factor \((x-1)^2\).</div><div class="step"><strong>Step 2:</strong> Degrees add to \(1+2=3\) ✓ (a cubic), choose any \(a>0\).</div><em>Conclusion: \(f(x)=a(x+3)(x-1)^2,\ a>0\). ✓</em></div>${gframe(["y = (x+3)*(x-1)^2"], { title: "f(x) = (x+3)(x−1)² with a=1: crosses at −3, touches at 1", labels: [{ x: -3, y: 0, t: "crosses", c: "#2563a0" }, { x: 1, y: 0, t: "touches", c: "#a3327a" }] })}</div>
  <div class="example-box" ${EX}><h3>Example 5: Least possible degree</h3><p>A polynomial <em>touches</em> the x-axis at two points and <em>crosses</em> at one. What is its least possible degree?</p><div class="solution"><div class="step"><strong>Step 1:</strong> Each touch needs even multiplicity, so at least 2 each; the crossing needs at least 1.</div><div class="step"><strong>Step 2:</strong> Minimum total \(=2+2+1\).</div><em>Conclusion: least degree \(5\). ✓</em></div>${gframe(["y = x*(x+2)^2*(x-2)^2"], { title: "f(x) = x(x+2)²(x−2)²: touches at −2 and 2, crosses at 0 — degree 5", labels: [{ x: -2, y: 0, t: "touch", c: "#a3327a" }, { x: 0, y: 0, t: "cross", c: "#2563a0" }, { x: 2, y: 0, t: "touch", c: "#a3327a" }] })}</div>
  <h2>🟡 Practice Questions</h2>
