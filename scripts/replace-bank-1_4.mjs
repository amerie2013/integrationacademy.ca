// Replace ONLY the "1.4 Exponent Laws" questions in the MTH1W bank, leaving
// every other topic (and any hand-added questions) untouched.
// Re-runnable. Usage: node scripts/replace-bank-1_4.mjs
