// Generate MCF3M worksheet .tex files from a content module.
//   node scripts/mcf3m-worksheets/build.mjs scripts/mcf3m-worksheets/content/u2.mjs
import fs from "fs";
...
\\input{_preamble}
\\fancyhead[R]{\\footnotesize MCF3M \\textperiodcentered{} ${w.code}}
\\begin{document}

\\begin{center}
{\\LARGE\\bfseries\\color{titleblue}Worksheet ${w.code} --- ${esc(w.title)}}\\\\[2pt]
{\\small Grade 11 Functions \\& Applications (MCF3M) \\textperiodcentered{} Unit ${w.unit}}
\\end{center}
