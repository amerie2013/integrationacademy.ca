// Generate MBF3C worksheet .tex files from a content module.
//   node scripts/mbf3c-worksheets/build.mjs scripts/mbf3c-worksheets/content/u2.mjs
import fs from "fs";
...
const esc = (s) => String(s).replace(/&/g, "\\&").replace(/_/g, "\\_"); // titles are text-mode
function render(w) {
...
\\input{_preamble}
\\fancyhead[R]{\\footnotesize MBF3C \\textperiodcentered{} ${w.code}}
\\begin{document}

\\begin{center}
{\\LARGE\\bfseries\\color{titleblue}Worksheet ${w.code} --- ${esc(w.title)}}\\\\[2pt]
{\\small Grade 11 Foundations for College Mathematics (MBF3C) \\textperiodcentered{} Unit ${w.unit}}
\\end{center}
